...
frags <- fread(cmd = paste0("zcat < ", frag_bedpe_file), col.names = c("read_name","chr", "start", "end", "bead_barcode")) 
barcode_translate <- fread(barcode_translate_file, col.names = c("bead_barcode", "cell_barcode"))
